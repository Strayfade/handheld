...
class GamepadState:
        ...
        def __init__(self):
                ...
                self.sLeftJoystickX = 0 #GlobalReader.LeftJoystickX.value
                self.sLeftJoystickY = 0 #GlobalReader.LeftJoystickY.value
                self.sRightJoystickX = 0 #GlobalReader.RightJoystickX.value
                self.sRightJoystickY = 0 #GlobalReader.RightJoystickY.value
                self.sLeftBumper = 0 #GlobalReader.LeftBumper.value
                self.sRightBumper = 0 #GlobalReader.RightBumper.value
                self.sLeftTrigger = 0 #GlobalReader.LeftTrigger.value
                self.sRightTrigger = 0 #GlobalReader.RightTrigger.value
...
class VirtualGamepad:
        def __init__(self, deviceName):
                ...
                DeviceCapabilities = [uinput.KEY_BACK, uinput.KEY_HOMEPAGE, uinput.BTN_SOUTH, uinput.BTN_EAST, uinput.BTN_C, uinput.BTN_NORTH, uinput.BTN_WEST, uinput.BTN_Z, uinput.BTN_TL, uinput.BTN_TR, uinput.BTN_TL2, uinput.BTN_TR2]
                DeviceCapabilities2 = [uinput.BTN_SELECT, uinput.BTN_START, uinput.BTN_MODE, uinput.BTN_THUMBL, uinput.BTN_THUMBR, uinput.ABS_X, uinput.ABS_Y, uinput.ABS_Z, uinput.ABS_RZ, uinput.ABS_GAS, uinput.ABS_BRAKE, uinput.ABS_HAT0X, uinput.ABS_HAT0Y]
